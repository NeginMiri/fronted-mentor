        ...
        return (
          ...
          >
            ...
            <div className="flex items-center justify-between pt-15">
              ...
              <div
                className={` w-[60px] h-[24px] rounded-full cursor-pointer flex justify-end  ${item.isActive ? "bg-gray-400 " : "bg-bg-100"} `}
              >
                <div
                  onClick={() => {
                    taggleCards(item.id);
                  }}
                  className={`w-[24px] h-[24px] rounded-full overflow-hidden bg-white  ${item.isActive ? "-translate-x-9 transition-all " : "translate-x-0 transition-all"} `}
                ></div>
              </div>
            </div>
          </div>
